...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <!-- Lokal CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('dist/main.css')); ?>">
    <style>
        .sidebar {
    position: fixed;
    top: 0;
...
<body>
    ...
    <header class="navbar navbar-expand sticky-top bg-primary navbar-dark flex-column flex-md-row bd-navbar">
        <a class="navbar-brand mr-0 mr-md-2" href="<?php echo e(url('/')); ?>">
...
?>
    ...
    <?php endif; ?>
                    ...
                    <?php if(auth()->guard()->check()): ?> <?php echo e(Auth::user()->nama_user); ?> <?php else: ?> Guest <?php endif; ?>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link <?php if(request()->routeIs('dashboard')): ?> active <?php endif; ?>"
                                ...
                                <span class="badge badge-primary"><?php echo e($dashboardCount ?? ''); ?></span>
                            </a>
                        </li>
                       <li class="nav-item">
        ...
        <i class="fa fa-calendar"></i><span> Schedule Management</span>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item has-child">
                            <a class="nav-link" href="<?php echo e(route('profile.view')); ?>">
...
<footer class="footer mt-auto py-3 bg-light border-top text-center">
    <div class="container">
        <span class="text-muted">
            &copy; <?php echo e(date('Y')); ?> Sistem Monitoring & Pengingat Jadwal Perkuliahan — All Rights Reserved.
        </span>
    </div>
</footer>
...
</html><?php /**PATH D:\kuliah\notif-wa\resources\views/layout/adminlayouts.blade.php ENDPATH**/ ?>